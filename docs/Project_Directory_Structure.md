...
* **representations/** — pretrained features, latent embeddings, trained autoencoder models, and representation-analysis artifacts.
...
The structure is designed to support representation-learning experiments while maintaining a consistent downstream VideoQA evaluation framework using Qwen2-VL-7B.
