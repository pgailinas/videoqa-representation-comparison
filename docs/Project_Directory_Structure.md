...
|----------|----------|--------------|-------------|---------|
| `baseline_predictions.csv` | `experiments/<experiment>/videoqa/` | Notebook 01 | Notebook 08 | Baseline multiple-choice prediction results. |
| `baseline_summary.csv` | `experiments/<experiment>/videoqa/` | Notebook 01 | Notebook 08 | Baseline experiment summary. |
| `baseline_validation.csv` | `experiments/<experiment>/videoqa/` | Notebook 01 | Notebook 08 | Validation of baseline prediction artifacts. |
...
| `reconstruction_metrics.csv` | `experiments/<experiment>/autoencoder/reports/` | Notebook 03 | Documentation | Autoencoder reconstruction performance metrics. |
| `autoencoder_segment_representations.csv` | `experiments/<experiment>/autoencoder/representations/` | Notebook 03 | Notebook 04 | Segment-level latent representations generated by the trained autoencoder. |
| `autoencoder_video_representations.csv` | `experiments/<experiment>/autoencoder/representations/` | Notebook 03 | Notebooks 04, 07 | Video-level latent representations generated by the trained autoencoder. |
| `autoencoder_representation_summary.csv` | `experiments/<experiment>/autoencoder/representations/` | Notebook 04 | Documentation | Summary of validated and standardized autoencoder representation artifacts. |
| `clip_text_representations.csv` | `representations/clip/text/` | Notebook 05 | Notebook 07 | Shared CLIP question-answer representations reused across representation-based VideoQA experiments. |
| `clip_text_representation_summary.csv` | `representations/clip/text/` | Notebook 05 | Documentation | Summary of shared CLIP text representations. |
| `clip_video_representations.csv` | `representations/clip/video/` | Notebook 06 | Notebook 07 | Shared pretrained CLIP video representations. |
| `clip_video_representation_summary.csv` | `representations/clip/video/` | Notebook 06 | Documentation | Summary of generated CLIP video representations. |
| `representation_videoqa_predictions.csv` | `experiments/<experiment>/videoqa/` | Notebook 07 | Notebook 08 | Representation-based multiple-choice prediction results. |
...
| `notebook08_summary.txt` | `evaluation/` | Notebook 08 | Documentation | Summary of the multi-experiment development evaluation. |
...
| **03** | Trained autoencoder model, segment representations, video representations and training reports | Notebook 04 |
| **04** | Validated and standardized autoencoder representation artifacts | Notebook 07 |
